...
public:
	...
	static SDL_Surface* loadImage(char* dir); //Static function to load an image from file.
	static SDL_Surface* loadImage(char* dir, Uint8 r, Uint8 g, Uint8 b); //Overloaded static funtion to load an image from file, using a defined RGB value as an ignore colour.

	int setSpeed(int); //Function to set the speed value.
	...
	int setX(); //Function to change X position of sprite.
	int setY(); //Function to change Y position of sprite.
	int getX(int); //Function to retreive X position of sprite.
	int getY(int); //Function to retreive Y position of sprite.
	...
	int setWidth(int); //Function to set the sprite frames width.
	int setHeight(int); //Function to set the sprite frames height.
